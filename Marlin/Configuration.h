...
#define STRING_CONFIG_H_AUTHOR "(Dean, Geeetech Prusa i3 Pro B)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    //Autotune: M303 E0 S220 C10

    // #define DEFAULT_Kp 50.57
    // #define DEFAULT_Ki 8.02
    // #define DEFAULT_Kd 79.74
    #define DEFAULT_Kp 32.68
    #define DEFAULT_Ki 3.02
    #define DEFAULT_Kd 88.34
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 143.66
  #define DEFAULT_bedKi 27.40
  #define DEFAULT_bedKd 502.13
...
#define STEP_ANGLE_X 1.80
#define STEPS_PER_REVOLUTION_X (360.0 / STEP_ANGLE_X)
#define IDLER_TEETH_X 20.0
#define BELT_PITCH_X 2.0

#define STEP_ANGLE_Y 1.80
#define STEPS_PER_REVOLUTION_Y (360.0 / STEP_ANGLE_Y)
#define IDLER_TEETH_Y 20.0
#define BELT_PITCH_Y 2.0

#define STEP_ANGLE_Z 1.80
#define STEPS_PER_REVOLUTION_Z (360.0 / STEP_ANGLE_Z)
#define LEADSCREW_PITCH_Z 1.25

#define STEP_ANGLE_E0 1.80
#define STEPS_PER_REVOLUTION_E0 (360.0 / STEP_ANGLE_E0)
#define PINCH_WHEEL_D_E0 9.7
#define GEAR_RATION_E0 16.0 //TODO: Must be checked again

#ifndef E0_MICROSTEPS
  #define E0_MICROSTEPS 1
#endif

// #define AXIS_STEPS_PER_UNIT_X 81
#define AXIS_STEPS_PER_UNIT_X (STEPS_PER_REVOLUTION_X  * X_MICROSTEPS / IDLER_TEETH_X / BELT_PITCH_X)
#define AXIS_STEPS_PER_UNIT_Y (STEPS_PER_REVOLUTION_Y  * Y_MICROSTEPS / IDLER_TEETH_Y / BELT_PITCH_Y)
#define AXIS_STEPS_PER_UNIT_Z (STEPS_PER_REVOLUTION_Z  * Z_MICROSTEPS / LEADSCREW_PITCH_Z)
#define AXIS_STEPS_PER_UNIT_E0 (STEPS_PER_REVOLUTION_E0 * E0_MICROSTEPS * GEAR_RATION_E0  / (PINCH_WHEEL_D_E0 * PI))
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4000, 500 }
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 78.74, 78.74, 2560, 105 } //GT250
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 81.5, 81.5, 2560, 105 } // is too big
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 81, 81, 2560, 105 }
#define DEFAULT_AXIS_STEPS_PER_UNIT {AXIS_STEPS_PER_UNIT_X, AXIS_STEPS_PER_UNIT_Y, AXIS_STEPS_PER_UNIT_Z, AXIS_STEPS_PER_UNIT_E0}
/**
 * Default Max Feed Rate (mm/s)
 * Override with M203
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
//Maximum feedrate X Y Z E
...
//#define CLASSIC_JERK
  ...
  #define DEFAULT_XJERK 10.0 //Maximum jerk X
  #define DEFAULT_YJERK 10.0 //Maximum jerk Y
  #define DEFAULT_ZJERK  0.3 //Maximum jerk Z
...
#define DEFAULT_EJERK    4.0  // May be used by Linear Advance //Maximum jerk E
...
#define X_MIN_POS -9 //if it hits the max stop, increase this val
#define Y_MIN_POS 0
#define Z_MIN_POS 0
